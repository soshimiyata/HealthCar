...
import CarEditView from "@/views/cars/CarEditView.vue";
...
import CustomEditView from "@/views/customs/CustomEditView.vue";
import PartsListView from "@/views/parts/PartsListView.vue";
import PartsCreateView from "@/views/parts/PartsCreateView.vue";
import PartsEditView from "@/views/parts/PartsEditView.vue";
...
import IssueEditView from "@/views/issues/IssueEditView.vue";
...
const routes = [
  { path: "/login", component: LoginView },
  {
    ...
    children: [
      ...
      { path: "cars/:carId/edit", component: CarEditView },
      ...
      { path: "cars/:carId/customs/:id/edit", component: CustomEditView },
      ...
      { path: "cars/:carId/parts/:id/edit", component: PartsEditView },
      ...
      { path: "cars/:carId/issues/:id/edit", component: IssueEditView },
